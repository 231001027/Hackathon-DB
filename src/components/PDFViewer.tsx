      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="glass-card relative max-h-[90vh] w-[90vw] max-w-4xl overflow-hidden flex flex-col">
            ...
            {/* PDF Viewer - Using embed for better compatibility */}
            <div className="overflow-auto bg-slate-50 dark:bg-slate-900 flex-1">
              <embed
                src={`${encodedPdfUrl}#toolbar=1&navpanes=0&scrollbar=1`}
            ...
            {false && (
              <div className="border-t border-slate-200/20 bg-slate-50/50 p-4 dark:border-slate-700/20 dark:bg-slate-900/50 flex items-center justify-between">
                <button disabled className="flex items-center gap-1 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-100 disabled:opacity-50 disabled:cursor-not-allowed dark:text-slate-400 dark:hover:bg-slate-800">
                  Previous
                </button>
